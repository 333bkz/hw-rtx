...
public class ENDownloadView extends View {
    ...
    public ENDownloadView(Context context, AttributeSet attrs) {
        ...
        mBgPaint.setStrokeWidth(DEFAULT_BG_LINE_WIDTH);
        mBgPaint.setColor(DEFAULT_BG_LINE_COLOR);
        ...
        switch (mCurrentState) {
            ...
            case STATE_END:
                ...
                if (mUnit != DownloadUnit.NONE && mCurrentSize > 0) {
                    canvas.drawText(String.format("%.2s", mCurrentSize)
                            + getUnitStr(mUnit), mCenterX, mCenterY + 1.4f * mBaseLength, mTextPaint);
                }
